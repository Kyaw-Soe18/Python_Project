...
urlpatterns = [
    ...
    path('faculty',views.department,name='department-page'),
    ...
    path('major',views.course,name='course-page'),
    ...
    path('teacher',views.faculty,name='faculty-page'),
    path('manage_teacher',views.manage_faculty,name='manage-faculty-modal'),
    path(r'view_teacher/<int:pk>',views.view_faculty,name='view-faculty-modal'),
    path(r'manage_teacher/<int:pk>',views.manage_faculty,name='edit-faculty-modal'),
    path('save_teacher',views.save_faculty,name='save-faculty'),
    path('delete_teacher',views.delete_faculty,name='delete-faculty'),
